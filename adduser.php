...
<form action="addreg.php" method="POST" style="">
  <div class="container" style="padding: 16px; background-color: white; width: 600px; margin-top: 20px;">
    ...
    <input type="text" placeholder="Enter Name" name="username" required pattern="[A-Za-z]{1,}" title="ONLY ALPHABETS ALLOWED"><br><br>

    <label for="password"><b>Password:</b></label>
    <input type="password" placeholder="Enter Password" name="password" required minlength="8"><br><br>

    <label for="email"><b>Email:</b></label>
    <input type="text" placeholder="Enter Email" name="email" required><br><br>

    <label for="phone"><b>Phone No:</b></label>
    <input type="text" placeholder="Enter Phone" name="phone" required pattern="[0-9]{10}" title="GIVE A 10 DIGIT..!!!"><br><br>

    <label for="address"><b>Address:</b></label>
    <input type="text" placeholder="Enter Address"name="address" required><br><br>
    <hr>

    <button name="adduser" type="submit" class="registerbtn" onsubmit="alert('hello')">Add user</button>
