...
$sql= "UPDATE reg SET password='$password' WHERE username='$username'";
...
?>  
          <h6><?php if($m!=""){echo $m;
            ?>
            Go to <a href="#">Log In</a> <?php
          }?></h6>
        <form action="login.php" method="POST">
            
            <input type="username" name="username" class="form" placeholder="Enter your username" required><br><br>
           
            <select>
               <option value="select">--SELECT SECURITY QUESTIONS--</option>
              <option value="select">what is your D.O.B</option>
              <option value="select">what is your mothername</option>
              <option value="select">who is your best-friend</option>
              <option value="select">what is your hobby</option>
            </select><br><br>
            <input type="answer" name="answer" class="form" placeholder="SQ ANSWER" required><br><br>
            <input type="username" name="username" class="form" placeholder="Enter New Password" required><br><br>
            <input id="password" type="username" name="username" class="form" placeholder="Confirm Password" required><br><br>
