...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1159B7;">
  ...
  <div class="container" style="padding: 16px; background-color: white; width: 600px; margin-top: 20px;">
    ...
    <input type="text" placeholder="Enter Name" name="username" required pattern="[A-Za-z]{1,}" title="ONLY ALPHABETS ALLOWED">
    ...
    <input type="text" placeholder="Enter Phone" name="phone" required pattern="[0-9]{10}" title="GIVE A 10 DIGIT..!!!><br>
